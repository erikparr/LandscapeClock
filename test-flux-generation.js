/**
 * Test script for FLUX image generation with explicit masking
 */

import 'dotenv/config';
import { generateDailyLandscape } from './server/services/fluxImageGenerator.js';
...
const outputDir = path.join(__dirname, 'static/images/2025-10-11-flux');
...
console.log('Starting FLUX generation test...');

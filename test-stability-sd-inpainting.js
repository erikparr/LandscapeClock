/**
 * Test script for Stability AI Stable Diffusion inpainting
 */
...
const outputDir = path.join(__dirname, 'static/images/2025-10-11-stability-sd');
...
console.log('Starting Stability AI SD inpainting test...');

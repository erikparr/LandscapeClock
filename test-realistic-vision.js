/**
 * Test script for Realistic Vision V5 inpainting
 */

import 'dotenv/config';
import { generateDailyLandscape } from './server/services/realisticVisionGenerator.js';
...
const outputDir = path.join(__dirname, 'static/images/2025-10-11-realistic');
...
console.log('Starting Realistic Vision V5 inpainting test...');

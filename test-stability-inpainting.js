/**
 * Test script for Stability AI SDXL inpainting
 */

import 'dotenv/config';
import { generateDailyLandscape } from './server/services/stabilityInpaintingGenerator.js';
...
const outputDir = path.join(__dirname, 'static/images/2025-10-11-stability');
...
console.log('Starting Stability AI SDXL inpainting test...');
